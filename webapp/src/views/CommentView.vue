            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <div class="space-y-4 md:space-y-6">
                        ...
                        <UIButton @click="add" :disabled="loading || !isInputsSet" classExtension="w-full px-5 py-2.5">
                            Добавить отзыв
                        </UIButton>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        add() {
            ...
            ExternalService.sendReport(this.selectedPage, this.fio, this.email, this.words, this.relative, (data) => {
        ...
        generate() {
            ...
            MemoryService.getGPT("gigachat", `Сгенерируй последнее прощание от ${this.relative} ${this.fio}, для умершего человека по имени ${page.name}`, data => {
