...
var USER_PROMPT_BIOGRAPHY = "Сгенируй продолжение детальной биографии (не повторяя то что было сделано ранее) для описания"
var USER_PROMPT_ENDING = "Сгенируй краткое заключение для биографии "
